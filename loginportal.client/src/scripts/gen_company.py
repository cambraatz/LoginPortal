...
users = {
    "COMPANY01": ["Brauns Express Inc", "TCSWEB"],
    "COMPANY02": ["Transportaion Computer Support, LLC", "TCSWEB"]
}

for key,value in users.items():
    query = "INSERT INTO dbo.COMPANY(COMPANYKEY,COMPANYNAME,COMPANYDB) VALUES (?,?,?);"
